...
const County_Enrollment = (props) => {
  const [inputs, setInputs] = useState({});
  const Countries = useFetchData("api/Counties");
  ...
  return (
    <div id="content" className="content">
      <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item active">County_Enrollment</li>
      </ol>
      <h1 class="page-header mb-3"> Enrollment per County</h1>
      <div style={{ backgroundColor: "white" }}>
        <div className="col-sm-12">
          <div className="row" style={{ paddingTop: "15px" }}>
            <div className="col-sm-6">
              <div class="form-group row m-b-15">
                <label class="col-form-label col-md-3">Select County</label>
                <div class="col-md-9">
                  <Select
                    name="countyID"
            ...
            <div className="col-sm-2">
              <div class="form-group row m-b-15">
                <label class="col-form-label col-md-6">All Counties</label>
                <div class="col-md-6">
                  {/* <br/> */}
                  <input
          ...
          <div className="col-sm-12">
            <div className="row">
              ...
              <div className="col-sm-8">
                ...
                <h5 className="text-center">TRAINEES ENROLMENT PER COUNTY</h5>
...
export default County_Enrollment;
